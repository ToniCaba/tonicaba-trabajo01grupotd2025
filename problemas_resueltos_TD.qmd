...
## Problema 1. Aplicar los criterios de decisión bajo incertidumbre.
...
cat("Criterio de Hurwicz (α = 0.4): la decisión óptima es la",
...
dibuja.criterio.Hurwicz_Intervalos(tb01a, TRUE, TRUE)
...
La alternativa **d2** resulta ser la más recomendada, ya que es seleccionada como óptima
por la mayoría de los criterios (Wald, Hurwicz y Laplace).
...
dibuja.criterio.Hurwicz_Intervalos(tb01b, FALSE, TRUE)
...
La alternativa **d1** es seleccionada como óptima por la mayoría de los criterios
(Wald, Hurwicz, Savage y Punto Ideal).
...
#Centro Comercial
m11 = 180000-3500*12-60000-36000-8000

#Barrio Universitario
m12 = 180000-2000*12-55000-36000-6000

#Zona Residencial
m13 = 180000-1200*12-50000-36000-5000


#Para e2:
#Centro Comercial
m21 = 120000-3500*12-60000-36000-8000

#Barrio Universitario
m22 = 120000-2000*12-55000-36000-6000

#Zona Residencial
m23 = 120000-1200*12-50000-36000-5000


#Para e3:
#Centro Comercial
m31 = 80000-3500*12-60000-36000-8000

#Barrio Universitario
m32 = 80000-2000*12-55000-36000-6000

#Zona Residencial
m33 = 80000-1200*12-50000-36000-5000
...
sol02 = criterio.Todos(tb02, 0.5, favorable = FALSE)
library(tinytable)
...
Según los distintos criterios de incertidumbre, Laura debería instalar su cafetería en el **centro comercial**.